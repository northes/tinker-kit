...
export interface PipelineTablePage {
    "rowsJSON": string;
    "columns": string[] | null;
    "total": number;
    "nextOffset": number;
...
export interface ReadPipelineResultPageRequest {
    "resultID": string;
    "offset": number;
    "limit": number;
}

export interface ReadPipelineTableRequest {
    "resultID": string;
    "offset": number;
    "limit": number;
}
...
export interface UpdatePipelineStateResult {
    "sessionID": string;
    "mutationID": number;
    "accepted": boolean;
    "conflict": boolean;
